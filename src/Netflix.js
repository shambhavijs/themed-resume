        ...
        <div className="main-page5">
            ...
            <div className="main-part5">
                {(props.state.link === true)?
                    ...
                    <section className="link-part5" >
                        {(port === 0 || port === '')?
                            <p>Copy this link {protocol}//{hostname}/{props.uid}/netflix</p>:
                            <p>Copy this link {protocol}//{hostname}:{port}/{props.uid}/netflix</p> 
                        }
                    </section>
                    </ClickAwayListener>:
                    <Fragment />
                }
                <section className="resume-part5">
                    <div className="first-row5">
                        <h1>{props.state.name}</h1>
                    </div>
                    <div className="second-row5">
                        <div className="first-col5">
                            <div className="col-items5">
                        ...
                        <div className="second-col5">
                            <div className="second-col-items5">
...
const NetflixContainer = connect(mapStateToProps, null)(Netflix);
