        ...
        <div className="main-page2">
            ...
            <div className="main-part2">
                {(props.state.link === true)?
                    ...
                    <section className="link-part2" >
                        {(port === 0 || port === null)?
                            <p>Copy this link {protocol}//{hostname}/{props.uid}/swiggy</p>:
                            <p>Copy this link {protocol}//{hostname}:{port}/{props.uid}/swiggy</p> 
                        }
                    </section>
                    </ClickAwayListener>:
                    <Fragment />
                }
                <section className="resume-part2">
                    <div className="first-row2">
                        <h1>{props.state.name}</h1>
                    </div>
                    <div className="second-row2">
                        <div className="first-col2">
                            <div className="col-items2">
                        ...
                        <div className="second-col2">
                            <div className="second-col-items2">
...
const SwiggyContainer = connect(mapStateToProps, null)(Swiggy);
