...
function Twitter(props) {
    ...
    return (
        ...
        <div className="main-page6">
            ...
            <div className="main-part6">
                {(props.state.link === true)?
                    <ClickAwayListener onClickAway={e=>hideLink()}>
                    <section className="link-part6" >
                        {(port === 0 || port === null)?
                            <p>Copy this link {protocol}//{hostname}/{props.uid}/twitter</p>:
                            <p>Copy this link {protocol}//{hostname}:{port}/{props.uid}/twitter</p> 
                        }
                    </section>
                    </ClickAwayListener>:
                    <Fragment />
                }
                <section className="resume-part6">
                    <div className="first-row6">
                        <div className="name-div6">{props.state.name}</div>
                    </div>
                    <div className="second-row6">
                        <div className="first-col6">
                            <div className="col-items6">
                        ...
                        <div className="second-col6">
                            <div className="second-col-items6">
