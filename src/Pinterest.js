    ...
    return (
        ...
        <div className="main-page10">
            ...
            <div className="main-part10">
                ...
                <section className="resume-part10">
                    <div className="first-row10">
                        <div className="name-div10">{props.state.name}</div>
                    </div>
                    <div className="second-row10">
                        <div className="first-col10">
                            <div className="col-items10">
                        ...
                        <div className="second-col10">
                            <div className="second-col-items10">
...
const PinterestContainer = connect(mapStateToProps, null)(Pinterest);
