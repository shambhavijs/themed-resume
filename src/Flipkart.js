...
function Flipkart(props) {
    ...
    return (
        ...
        <div className="main-page4">
            ...
            <div className="main-part4">
                {(props.state.link === true)?
                    <ClickAwayListener onClickAway={e=>hideLink()}>
                    <section className="link-part4" >
                        {(port === 0 || port === null)?
                            <p>Copy this link {protocol}//{hostname}/{props.uid}/flipkart</p>:
                            <p>Copy this link {protocol}//{hostname}:{port}/{props.uid}/flipkart</p> 
                        }
                    </section>
                    </ClickAwayListener>:
                    <Fragment />
                }
                <section className="resume-part4">
                    <div className="first-row4">
                        <h1>{props.state.name}</h1>
                    </div>
                    <div className="second-row4">
                        <div className="first-col4">
                            <div className="col-items4">
                        ...
                        <div className="second-col4">
                            <div className="second-col-items4">
...
const FlipkartContainer = connect(mapStateToProps, null)(Flipkart);
export default FlipkartContainer;